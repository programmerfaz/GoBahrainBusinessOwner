...
-- Deletes client and all linked records (place, place_client, restaurant_client, event_clients, posts via CASCADE)
...
BEGIN
  ...
  BEGIN
    DELETE FROM public.event_clients WHERE a_uuid = p_client_uuid;
