...
export default function Home() {
      ...
      <div className="page dashboard-v2">
        <section className="dash-hero-v2">
          ...
          <div className="dash-hero-v2-inner">
            ...
            <Link to="/profile" className="btn btn-hero">Create your profile</Link>
          </div>
        </section>
  ...
  // ——— Signed in, one profile: show posts only (dashboard) ———
    ...
    <div className="page dashboard-v2 home-posts">
      <section className="dash-hero-v2 dash-hero-posts">
        ...
        <div className="dash-hero-v2-inner">
          ...
          <Link to="/profile" className="btn btn-hero btn-outline">Profile</Link>
        </div>
      </section>
      ...
      {/* Edge case: signed in but multiple profiles (legacy) — show simple message and link to profile */}
      {!loading && clients.length > 1 && (
        <section className="dash-unified">
          <p>You have more than one profile. Manage them from <Link to="/profile">Profile</Link>.</p>
        </section>
      )}
    </div>
  )
